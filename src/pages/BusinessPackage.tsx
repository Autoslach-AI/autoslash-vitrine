        ...
        <div className="px-10 pt-32 pb-20 max-w-[1700px] mx-auto w-full">
          ...
          <div className="flex flex-col gap-2 mb-10">
            <div className="flex items-end gap-5">
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight text-white/90 uppercase">SCALER VOTRE BUSINESS</h1>
            ...
            <p className="text-white/40 text-lg max-w-4xl font-medium mt-4 leading-relaxed">
              Déployez un écosystème intelligent conçu pour automatiser vos opérations et <span className="text-[#2a6df5]">scaler vos revenus sans effort</span>. 
              Prêt à faire passer votre business à la vitesse supérieure ?
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-x-6 gap-y-10">
            {loading ? (
              ...
              currentTemplates.map((template, idx) => (
                ...
                >
                  <TemplateCard template={template} index={idx} packageType="BUSINESS" />
                </div>
              ))
            )}
          </div>
