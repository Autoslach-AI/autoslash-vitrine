...
const options = [
  "Lancer mon projet ou startup",
  "Scaler mon entreprise existante",
  "Automatiser mes opérations",
  "Explorer ce qu'Autoslash peut faire",
  "Autre"
];

export default function OnboardingStep1({ value, onChange, onNext }: Props) {
      ...
      <AnimatePresence>
        {isOther && (
          ...
          >
            <input
              type="text"
              placeholder="Précisez votre intention..."
