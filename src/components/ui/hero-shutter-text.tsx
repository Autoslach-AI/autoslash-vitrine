...
export default function HeroText({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "relative flex flex-col items-center justify-center h-full w-full bg-white dark:bg-black transition-colors duration-700",
        className
      )}
    >
      {/* Immersive Background Grid - only if not transparent */}
            ...
            {characters.map((char, i) => (
              ...
              >
                ...
                <motion.span
                  ...
                  className="text-[12vw] md:text-[15vw] leading-none font-black text-zinc-900 dark:text-white tracking-tighter"
                >
                  {char === " " ? "\u00A0" : char}
                </motion.span>
                ...
                <motion.span
                  ...
                  className="absolute inset-0 text-[12vw] md:text-[15vw] leading-none font-black text-blue-500 dark:text-blue-400 z-10 pointer-events-none"
                ...
                <motion.span
                  ...
                  className="absolute inset-0 text-[12vw] md:text-[15vw] leading-none font-black text-zinc-800 dark:text-zinc-200 z-10 pointer-events-none"
                  style={{
      ...
      {/* Floating UI Controls - hidden if in a section */}
      {!className.includes("bg-transparent") && (
      ...
      {/* Corner Accents - hidden if in a section */}
      {!className.includes("bg-transparent") && (
        <>
