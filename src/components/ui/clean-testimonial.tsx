...
export function Testimonial() {
  ...
  const fillTextStyle: React.CSSProperties = {
    ...
    backgroundClip: "text",
    backgroundColor: "rgba(0,0,0,0.1)", // muted
    backgroundImage: "linear-gradient(135deg, #000 50%, rgba(0,0,0,0.1) 60%)",
      ...
      <div className="relative">
        <AnimatePresence mode="wait">
          <motion.blockquote
            ...
            className="text-xl md:text-2xl font-black leading-relaxed tracking-tight text-foreground"
          >
            <span ref={quoteRef} style={fillTextStyle}>
