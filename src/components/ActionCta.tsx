...
export const ActionCta = ({ onCTAClick }: { onCTAClick?: (dest: string) => void }) => {
  return (
    <section className="relative w-full overflow-hidden bg-black">
      ...
      >
        <div className="flex flex-col items-center space-y-8 z-50">
          ...
          <p className="text-white/40 text-sm md:text-base font-medium tracking-[0.2em] uppercase pt-4 text-center">
