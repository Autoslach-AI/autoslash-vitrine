...
const ALL_INDUSTRIES = [
  "IA Générative", "Automation Totale", "CRM Intelligent", "Data Analytics", "Sécurité Bancaire", "SaaS Enterprise", "Logistique Mondiale", "RH Augmentée", "Marketing Prédictif", "ERP Custom",
  "Mode", "SaaS", "À propos", "Page d'accueil", "Barre latérale", "Assistant virtuel", 
  "Tableaux de bord", "Événement", "Restaurant", "Profil utilisateur", "Menu", "E-commerce", 
  "E-learning", "Simple", "Design d'intérieur", "Mariage", "CRM", "Site personnel", 
  "Voyage", "Entreprise", "Immobilier", "Photographie", "S'inscrire", "Marketplace", 
  "Connexion", "Blog", "Portfolio", "Barre de navigation", "CMS", "Finance", 
  "Santé", "Éducation", "Bâtiment", "Technologie", "Art", "Musique", "Cinéma",
  "Sport", "Automobile", "Juridique", "Mode de vie", "Voyages", "Actualités", 
