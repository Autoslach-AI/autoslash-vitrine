    ...
    <div className="w-full py-40 bg-zinc-950/50 border-t border-white/5">
      <div className="max-w-[1700px] mx-auto px-10">
        <div className="flex flex-col gap-4 mb-20 text-center">
          <span className="text-[11px] font-black uppercase tracking-[0.5em] text-[#2a6df5]">Suggestions Business</span>
          <h2 className="text-4xl md:text-5xl font-bold tracking-tight text-white leading-none uppercase italic">Solutions Similaires</h2>
        </div>
            ...
            >
              <div className="relative aspect-[4/5] rounded-[2.5rem] overflow-hidden bg-neutral-900 border border-white/5 transition-all duration-500 hover:border-[#2a6df5]/30 shadow-2xl shadow-black/50">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 flex flex-col justify-end p-8">
                  ...
                  <p className="text-white text-xl font-bold uppercase italic">{template.title}</p>
                </div>
              </div>
