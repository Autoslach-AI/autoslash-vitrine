    ...
    >
      ...
      <div className="flex items-start justify-between px-1">
        <div className="flex flex-col gap-0.5 max-w-[80%]">
          <h3 className="text-[11px] font-black text-white truncate leading-tight uppercase tracking-tight group-hover:text-[#2a6df5] transition-colors">{template.title}</h3>
        </div>
